...
Friend Class HDMFExportInfo
    ...
    Public Sub New(ByVal pMenu As Integer, ByVal c As SqlClient.SqlConnection, ByVal pListing As DataTable, ByVal pID As Integer)
        ...
        'mExportToXLLoanFileButton = MyBase.AddButton("Export Loan File (BPI)", gMainForm.imgList.Images("textfile.png"), AddressOf Generate_TextFile) 'Text Format
...
#Region "Procedures"
    ...
    Public Sub AddEmployee(ByVal sender As Object, ByVal e As EventArgs)
        If Not Me.HasUnsavedChanges Then
            ...
            s &= " AND ID NOT IN (SELECT ID_Employee FROM tHDMFExport_Detail WHERE ID_HDMFExport =" & myDT.Get(Database.Tables.tHDMFExport.Field.ID).ToString & ")"
            ...
            If f.ShowDialog() = DialogResult.OK And f.GetTable IsNot Nothing Then
                ...
                For Each dr As DataRow In f.GetTable.Select()
                    GSCOM.SQL.ExecuteNonQuery("EXEC pHDMFExportPerEmp " & myDT.Get(Database.Tables.tHDMFExport.Field.ID).ToString & "," & dr("ID").ToString, Connection)
                Next
            Else
                Exit Sub
            End If
