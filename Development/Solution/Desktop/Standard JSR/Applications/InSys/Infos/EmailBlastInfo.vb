...
Friend Class EmailBlastInfo
    Inherits InfoSet

    Private WithEvents myDT As New Database.Tables.tEmailBlast(Connection)
    Dim mtEmailBlast_Detail As GSCOM.SQL.ZDataTable
    ...
    Public Sub New(ByVal pMenu As Integer, ByVal c As SqlClient.SqlConnection, ByVal pListing As DataTable, ByVal pID As Integer)
        ...
        mtEmailBlast_Detail = DirectCast(Me.mDataset.Tables("tEmailBlast_Detail"), GSCOM.SQL.ZDataTable)

        mGrid = Me.GetDataGridView(mtEmailBlast_Detail)
