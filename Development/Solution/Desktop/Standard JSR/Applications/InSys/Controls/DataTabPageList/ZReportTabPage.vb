...
'Friend Class ZReportTabPage
'    Inherits System.Windows.Forms.TabPage
'    Implements GSCOM.Interfaces.ZIDataTabPageList

'#Region " Windows Form Designer generated code "

'    Public Sub New(ByVal tableName As String, ByVal c As Data.SqlClient.SqlConnection, ByVal pSubDataSource As DataTable)
'        MyBase.New()
...
'        mMainList.SubDataSource = pSubDataSource
...
'    Private WithEvents mMainList As ZReportViewer
'    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
'        Me.mMainList = New ZReportViewer
'        Me.SuspendLayout()
'        '
'        'MainList
'        '
